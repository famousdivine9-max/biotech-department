...
import { uploadMaterial, getPublicMaterials, getLecturerMaterials, trackDownload, updateMaterial, deleteMaterial, adminDeleteMaterial } from '../controllers/materialController';
